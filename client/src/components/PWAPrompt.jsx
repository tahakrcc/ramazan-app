    ...
    return (
        <AnimatePresence>
            ...
            {isStandalone && !showNotificationPrompt && Notification.permission === 'granted' && (
                <button 
                    onClick={toggleNotification}
                    className="fixed top-6 right-6 z-50 w-10 h-10 bg-gold-500 border border-gold-500/30 rounded-full flex items-center justify-center text-dark-950 shadow-lg"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
